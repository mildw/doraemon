package com.example.springsecurity.config.database;
...
@EnableJpaRepositories(basePackages = {"com.example.springsecurity.domain"})
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.example.springsecurity.domain");
