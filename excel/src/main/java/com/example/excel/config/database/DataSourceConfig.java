package com.example.excel.config.database;
...
@EnableJpaRepositories(basePackages = {"com.example.excel.domain"})
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.example.excel.domain");
