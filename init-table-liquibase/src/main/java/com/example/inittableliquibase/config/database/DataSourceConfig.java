package com.example.inittableliquibase.config.database;
...
@EnableJpaRepositories(basePackages = {"com.example.inittableliquibase.domain"})
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.example.inittableliquibase.domain");
