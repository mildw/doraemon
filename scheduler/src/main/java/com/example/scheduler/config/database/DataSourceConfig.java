package com.example.scheduler.config.database;
...
@EnableJpaRepositories(basePackages = {"com.example.scheduler.domain"})
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.example.scheduler.domain");
