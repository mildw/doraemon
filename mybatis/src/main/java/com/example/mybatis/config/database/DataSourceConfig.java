package com.example.mybatis.config.database;
...
@EnableJpaRepositories(basePackages = {"com.example.mybatis.domain"})
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.example.mybatis.domain");
