package com.example.entitylistener.config.database;
...
@EnableJpaRepositories(basePackages = {"com.example.entitylistener.domain"})
public class DataSourceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.example.entitylistener.domain");
